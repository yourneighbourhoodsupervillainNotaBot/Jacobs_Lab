...
def trace_test_walk(
    ...
    from jacobs_lab.testing.test_walk_engine import build_test_tree, taken_path
...
# ----------------------------------------------------------------------
def trace_flexagon():
    from jacobs_lab.structure.flexagon import STRIP, PIVOT, face, flex, fold_packet
...
def trace_portal_natural_transformation():
    from jacobs_lab.math_lenses.natural_transformations import build_portal_natural_isomorphism
