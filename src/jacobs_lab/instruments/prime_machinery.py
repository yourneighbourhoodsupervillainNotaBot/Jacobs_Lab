...
from jacobs_lab.math_lenses.galois_fields import is_prime, multiplicative_order
from jacobs_lab.core.general_recursive_mapper import RecursiveTopology, digital_root
