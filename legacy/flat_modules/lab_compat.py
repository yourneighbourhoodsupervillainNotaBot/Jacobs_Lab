...
def import_folding():
    """Import the folding VM module regardless of local spelling."""
    try:
        return importlib.import_module("folding_computation")
    except ModuleNotFoundError:
        return importlib.import_module("folding_computations")
