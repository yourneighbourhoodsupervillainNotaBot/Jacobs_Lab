...
from jacobs_lab.math_lenses.category_theory import FiniteCategory, thin_category
from jacobs_lab.structure.folding_graph import FoldingGraph
...
from jacobs_lab.math_lenses.set_theory import portal_quotient, quotient_set
