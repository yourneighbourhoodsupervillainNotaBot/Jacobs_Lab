...
try:  # module may be named folding_computation.py or folding_computations.py
    from folding_computation import Combine, Instr, Pred, run_program
except ModuleNotFoundError:  # pragma: no cover
    from legacy.flat_modules.folding_computations import Combine, Instr, Pred, run_program

from legacy.flat_modules.general_recursive_mapper import RecursiveMapper, digital_root
